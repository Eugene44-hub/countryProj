...
class UI {
    ...
    display() {
        ...
        for (let i = 0; i < this.country.length; i++) {
            ...
            if (this.country[i].capital === undefined) {
                output += ` 
              <div class="country" style='box-shadow2px 4px 15px rgb(235, 235, 235), -2px 0px 15px rgb(235, 235, 235);'>
              <div class="image">
             <img src=${this.country[i].flags.png}>
              ...
              <p id="population">Population: ${this.country[i].population}</p>
                ...
                output += ` 
              <div class="country" style='box-shadow:2px 4px 15px rgb(235, 235, 235), -2px 0px 15px rgb(235, 235, 235);'>
              <div class="image">
             <img src=${this.country[i].flags.png}>
              </div>
              <div class="about-country">
    ...
    static theme() {
        ...
        if (getComputedStyle(document.body).backgroundColor === 'rgb(250, 250, 250)') {
            ...
            region.style.boxShadow = '2px 4px 15px rgb(29, 29, 29), -2px -0px 5px hsl(209, 23%, 22%)';
            ...
            region.style.boxShadow = '0px 1px 10px rgb(235, 233, 233)';
