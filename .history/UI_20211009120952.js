        ...
        for (let i = 0; i < this.country.length; i++) {
            ...
            if (this.country[i].capital === undefined) {
             ...
             <img src=${this.country[i].flags.png}>
              ...
              <div class="about-country">
              <p id=name>${this.country[i].name.common}</p>
                  <p id="population"><h3>Population</h3>: ${this.country[i].population}</p>
                  <p id="region"><h3>Region</h3>: ${this.country[i].region}</p>
                  <p id="capital"><h3>Capital<h3>: ${this.country[i].capital[0]}</p>
              </div>
          </div>`
            }
        }
