...
mode.addEventListener('click', e => {
    ...
    if (getComputedStyle(document.body).backgroundColor === 'rgb(250, 250, 250)') {
        ...
        for (let i = 0; i < countryInfo.length; i++) {
            countryInfo[i].style.boxShadow = '2px 2px 10px hsl(209, 23%, 22%)';
        }
        ...
        search.style.boxShadow = '2px 2px 10px hsl(209, 23%, 22%)';
        select.style.boxShadow = '2px 2px 10px box-shadow: 0px 1px 10px rgb(235, 233, 233);';
        for (let i = 0; i < countryInfo.length; i++) {
            countryInfo[i].style.boxShadow = ' 2px 4px 15px rgb(223, 220, 220)';
        }
