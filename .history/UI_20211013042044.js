...
class UI {
    ...
    static theme() {
        ...
        if (getComputedStyle(document.body).backgroundColor === 'rgb(250, 250, 250)') {
            ...
            countryInfo.style.boxShadow = '2px 4px 15px rgb(29, 29, 29), -2px -0px 5px hsl(209, 23%, 22%)';
            //  hsl(207, 26%, 17%)
            ...
            countryInfo.style.boxShadow = '2px 4px 15px rgb(235, 235, 235), -2px -0px 15px rgb(235, 235, 235)';
