    ...
    display() {
        ...
        for (let i = 0; i < this.country.length; i++) {
           ...
           <img src=${this.country[i].flags.png}>
            ...
            if (this.country[i].capital[i] === undefined) {
                document.querySelector('#capital').textContent = 'No capital';
            } else {
                document.querySelector('#capital').textContent = '${this.country[i].capital[i]}
            }
        }
