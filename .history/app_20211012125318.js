...
mode.addEventListener('click', e => {
    ...
    if (getComputedStyle(document.body).backgroundColor === 'rgb(250, 250, 250)') {
        ...
        for (let i = 0; i < countryInfo.length; i++) {
            countryInfo[i].style.boxShadow = '2px 4px 15px hsl(209, 23%, 22%), -2px 0px 15px hsl(209, 23%, 22%)';
        }
        ...
        for (let i = 0; i < countryInfo.length; i++) {
            countryInfo[i].style.boxShadow = '2px 4px 10px rgb(235, 235, 235), -2px 0px 10px rgb(235, 235, 235)';
        }
