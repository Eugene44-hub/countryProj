...
mode.addEventListener('click', e => {
    ...
    if (getComputedStyle(document.body).backgroundColor === 'rgb(250, 250, 250)') {
        ...
        for (let i = 0; i < countryInfo.length; i++) {
            countryInfo[i].style.boxShadow = 'hsl(209, 23%, 22%), -2px 0px 15px rgb(235, 235, 235)';
        }
        ...
        select.style.boxShadow = '2px 2px 10px rgb(235, 233, 233);';
        for (let i = 0; i < countryInfo.length; i++) {
            countryInfo[i].style.boxShadow = 'rgb(235, 235, 235), -2px 0px 15px rgb(235, 235, 235)';
        }
